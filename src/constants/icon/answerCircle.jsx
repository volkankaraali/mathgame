const AnswerCircle = props => (
    <svg width={props.width || "203"} height={props.height || "178"} viewBox="0 0 203 178" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="70" y="105" fontSize="64" fill="white">{props.data}</text>
    </svg>
)
